...
function showSlides(n) {
  var i;
  var order;
  var imgSrc = document.getElementById("actual_img");
  ...
  for (i = 0; i < dots.length; i++) {
    ...
    dots[i].src = "./images/img" + order.toString() + ".jpg";
    console.log("order" + order.toString());
  }

  imgSrc.src = "./images/img" + slideIndex.toString() + ".jpg"; //dots[slideIndex-1].className += " active";
